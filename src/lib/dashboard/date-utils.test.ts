...
describe("mondayIndex", () => {
  // Build dates with the local-time constructor: "2026-05-18" strings parse
  // as UTC midnight, which is still the previous (local) day in UTC-negative
  // timezones like Brazil — mondayIndex works on local dates, as its callers do.
